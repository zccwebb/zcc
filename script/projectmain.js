import { mapClasses, previews } from "../data/data.js";
 ...
 `;
  ...
  items.forEach((item, index) => {
    item.addEventListener("mouseenter", () => {
      ...
      const newBg = `./assets1/bg-${index + 1}.jpg`;
      changeBg(newBg);
...
function showTime(){
  ...
  document.querySelector(".local-time p").innerText = time;
  document.querySelector(".local-time p").textContent = time;
